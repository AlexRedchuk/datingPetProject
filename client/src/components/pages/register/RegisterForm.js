...
class RegisterForm extends Component {
        ...
        if (this.props.step === 1) {
            ...
            return (
                <>
                    ...
                    <Field name="email" component={this.renderInput} label="Email" placeholder="Введіть ваш Email" />
                    <Field name="password" component={this.renderInput} label="Пароль" placeholder="Введіть пароль" type="password" />
                    <button disabled={invalid} type="button" onClick={() => this.props.changeStep(2)} className="registration_button">Створити аккаунт </button>
                </>
            )
        }
    ...
    render() {
        return (
            ...
            } onSubmit={this.props.handleSubmit(this.onSubmit)} className="register_auth_form">
                {this.renderSteps()}
            </form>
        );
    }
